package com.chat.ai.config.aspect;

import com.chat.ai.config.annotation.RateLimit;
import com.chat.ai.exception.RateLimitExceededException;
...
public class RateLimitAspect {
    ...
    @Around("@annotation(com.chat.ai.config.annotation.RateLimit) || " +
            "@annotation(com.chat.ai.config.annotation.RateLimit.Container)")
